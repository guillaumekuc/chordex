<template>
  <div
    ...
    @click="handleClick"
  >
    <div class="horizontal-scroll-line-content">
      <slot></slot>
    </div>
...
.horizontal-scroll-line::-webkit-scrollbar {
  display: none; /* Chrome, Safari, Opera */
}

.horizontal-scroll-line-content {
  display: flex;
  align-items: center;
  height: 100%;
  width: max-content;
...
.horizontal-scroll-line.can-scroll {
  cursor: grab;
}

.horizontal-scroll-line.can-scroll:active {
  cursor: grabbing;
}
