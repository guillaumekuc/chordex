        ...
        try {
          ...
          store.chordRelationships.forEach((cr) => {
            ...
            if (importedProps) {
              ...
              if (importedProps.aliases !== undefined)
                cr.aliases = importedProps.aliases;
              if (importedProps.tags !== undefined)
                cr.tags = importedProps.tags;
              if (importedProps.notes !== undefined)
                cr.notes = importedProps.notes;
              updatedCount++;
            }
          });
